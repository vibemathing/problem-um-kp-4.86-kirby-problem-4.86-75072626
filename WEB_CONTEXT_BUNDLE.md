...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.86-kirby-problem-4.86-75072626-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.86"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.86-kirby-problem-4.86-75072626-v1",
      "problem_contract_sha256": "1afdb8df964e58cc24991e4ed16349ab14b4010d3c34486895c7e4497437434d",
      "problem_id": "problem:um-kp-4.86-kirby-problem-4.86-75072626",
      "route_id": "route:um-kp-4.86-kirby-problem-4.86-75072626-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.86-kirby-problem-4.86-75072626-source-fidelity-01",
      "graph_id": "graph:um-kp-4.86-kirby-problem-4.86-75072626-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.86-kirby-problem-4.86-75072626-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.86-kirby-problem-4.86-75072626-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Is it the case that for every closed, smoothable topological 4manifold X, there exists a locally linear finite group action on X, such that for every smooth structure on X, the action is non-smoothable?"
          },
          "statement_sha256": "b35ec7b42d0891ed96aa2eb0cfc7878d1911f6d82045d680b57d2f97e3e52d3d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.86-kirby-problem-4.86-75072626-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.86-kirby-problem-4.86-75072626-root",
      "route_id": "route:um-kp-4.86-kirby-problem-4.86-75072626-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.86-acab34b33c5c",
        "url": "https://www.unsolvedmath.com/problems/KP-4.86"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
